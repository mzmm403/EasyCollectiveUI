...
describe("Alert.vue", () => {
    ...
    it("should support centering text", () => {
        ...
        //class
        const rootNode = wrapper.find(".ec-alert");
    ...
    it("should not render close icon when closable is false", () => {
        ...
        expect(wrapper.find(".ec-alert__close").exists()).toBe(false);
    });
    ...
    it("should toggle visibility when open and close methods are called", async () => {
        ...
        expect(wrapper.find(".ec-alert").attributes().style).toBe("display: none;");
        await wrapper.vm.open();
        expect(wrapper.find(".ec-alert").attributes().style).toBe("");
    });
}); 